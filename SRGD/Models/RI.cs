    ...
    public class RI
    {
       ...
       public DataTable RepeatAnnotation(string RAT)
        ...
        SqlConnection con = new SqlConnection(_config.GetConnectionString("MASTER"));
            ...
            SqlCommand command = new SqlCommand(String.Format("SELECT STARTING,ENDING, REPETITIVE_SEQUENCE, REPEAT_COUNT  FROM {0} GROUP BY STARTING,ENDING,REPETITIVE_SEQUENCE, REPEAT_COUNT", RAT), con);
            con.Open();
